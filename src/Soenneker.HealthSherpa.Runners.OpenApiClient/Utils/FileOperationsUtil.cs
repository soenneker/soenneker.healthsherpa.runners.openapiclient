...
using Soenneker.HealthSherpa.Runners.OpenApiClient.Utils.Abstract;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["HealthSherpa:ClientGenerationUrl"] ?? "https://one.healthsherpa.com/openapi.json";
        ...
        if (filePath == null)
            throw new InvalidOperationException("HealthSherpa OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "HealthSherpaOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
